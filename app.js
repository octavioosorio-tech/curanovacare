...
const texts = {
  es: {
    ...
    invalidAge: "Por favor indica tu edad en años usando solo números. Ejemplo: 15",
    askAge:
...
const conditionRules = [
  ...
  },
  {
    ...
    pharma: {
      ...
      ja: "場合によっては、経口補水液や市販の胃腸薬が使われることがありますが、必ず医療専門職や薬剤師の説明に従ってください。",
  ...
  },
  {
    ...
    pharma: {
      ...
      ja: "一般的に市販の抗ヒスタミン薬が使われることがありますが、必ず用法・用量と医療従事者の指示に従ってください。",
  ...
  },
  {
    ...
    pharma: {
      ...
      ja: "痛みを和らげるために市販の鎮痛약을 사용할 수 있지만, 必ず用法・用量과 医療従事者의 指示に従ってください。",
